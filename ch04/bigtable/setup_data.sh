...
# gcloud bigtable instances create bqbook-instance --cluster=bqbook-cluster --cluster-zone=us-central1-a --display-name=bqbook-instance --instance-type=DEVELOPMENT
